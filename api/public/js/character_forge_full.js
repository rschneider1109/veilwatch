...
(function(){
  ...
  function render(){
    ...
    if(c){
      ...
      c.innerHTML=`<div class="mini">MakeHuman wardrobe online: ${totalCount} fitted garments and accessories plus body-fitted outerwear aliases. Native .mhclo fitting keeps equipped assets attached while body proportions change, and inactive assets are disposed instead of accumulating in memory.</div>`+
